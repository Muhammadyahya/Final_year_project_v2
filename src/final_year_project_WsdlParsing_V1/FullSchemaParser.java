...
public class FullSchemaParser {
    ...
    public static void main(String[] args) {
         ...
         Schema schema1 = new Schema("http://predic8.com/schema/person/");
     
    schema1.newElement("person", "personType");
    
    ComplexType personType = schema1.newComplexType("personType");
    ...
    seq.newElement("address").newComplexType().newSequence().newElement("country", STRING);
        ...
        Schema schema = parser.parse(schema1.getAsString());
